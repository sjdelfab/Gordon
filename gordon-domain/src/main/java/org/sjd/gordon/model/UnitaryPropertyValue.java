...
@Entity
@Table(name = "unitary_value")
public class UnitaryPropertyValue {
	...
	private UnitaryPropertyDefinition definition;
	...
	public UnitaryPropertyDefinition getDefinition() {
		return definition;
	}
	
	public void setDefinition(UnitaryPropertyDefinition definition) {
